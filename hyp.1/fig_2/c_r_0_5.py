...
c_r = 0.5  # relative cost of choosiness
...
for i_delta_a, delta_a in enumerate(L_delta):
    ...
    for i_delta_c, delta_c in enumerate(L_delta):
        ...
        if i_delta_a % 1 == 0  and i_delta_c % 1 == 0 and os.path.isfile('c_r_0_5/Nf_' + str(i_delta_a) + '_' + str(i_delta_c) + '.npy') == False:
            ...
            N_ = np.copy(N_inv)
            np.save('c_r_0_5/Neq_' + str(i_delta_a) + '_' + str(i_delta_c), N_)
            ...
            np.save('c_r_0_5/Nf_' + str(i_delta_a) + '_' + str(i_delta_c), N_)
